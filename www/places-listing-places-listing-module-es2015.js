...
let PlacesListingPageModule = class PlacesListingPageModule {
};
...
let PlacesListingPage = class PlacesListingPage {
...
PlacesListingPage.ctorParameters = () => [
...
let PlacesListingResolver = class PlacesListingResolver {
    constructor(placesService) {
        this.placesService = placesService;
    }
    resolve() {
        const dataSource = this.placesService.getListingDataSource();
        const dataStore = this.placesService.getListingStore(dataSource);
        return dataStore;
    }
};
PlacesListingResolver.ctorParameters = () => [
...
//# sourceMappingURL=places-listing-places-listing-module-es2015.js.map